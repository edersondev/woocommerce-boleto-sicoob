...
class WC_Boleto_Siccob_Admin {
	...
	public function register_metabox() {
		add_meta_box(
			...
			__( 'Boleto', 'woocommerce-boleto-sicoob' ),
	...
	public function metabox_content( $post ) {
		...
		if ( 'boleto_sicoob' == $order->payment_method ) {
			...
			$html .= '<p><strong>' . __( 'URL:', 'woocommerce-boleto' ) . '</strong> <a target="_blank" href="' . esc_url( wc_boleto_sicoob_get_boleto_url( $order->order_key ) ) . '">' . __( 'View boleto', 'woocommerce-boleto' ) . '</a></p>';
